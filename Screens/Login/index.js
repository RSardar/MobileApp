...
export default class Login extends React.Component {
  ...
  storeData = async (value) => {
    ...
    try {
      //Use Always Object
      await AsyncStorage.setItem("userId", JSON.stringify(value["userId"]));
      await AsyncStorage.setItem("photographer", JSON.stringify(value["type"]));
      // console.log(value2);
