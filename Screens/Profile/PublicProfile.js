...
export default class PublicProfile extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      getId: this.props.route.params.userId,
      // getId: 15,
      clickedPhotographerId: this.props.route.params.userId,
      photographerAllData: "",
      isLoading: true,
      allGalleryImg: "",
      userName: "Suhrita",
  ...
  async componentDidMount() {
    if (
      ...
      this.props.route.params.photographer
    ) {
      this.setState({
        getId: this.props.route.params.userId,
        clickedPhotographerId: this.props.route.params.photographer,
      });
      this.PhotographerData(this.props.route.params.userId);
      this.UserGallary(this.props.route.params.photographer, 12);
    } else {
      this.storedData();
      console.log("hello from else");
      this.PhotographerData(this.state.getId);
      this.UserGallary(this.state.clickedPhotographerId, 12);
    }
  }
  ...
  storedData = async () => {
    try {
      await AsyncStorage.getItem("userId").then((value) =>
        this.setState({
          getId: JSON.parse(value),
          clickedPhotographerId: JSON.parse(value),
        })
      );
    } catch (e) {
      // error reading value
          ...
          >
            <View style={styles.justUploadedMainBox}>
              ...
              <View style={styles.imageBoxForm}>
                <View
                  style={[styles.imageBoxFormEachSection, { marginBottom: 10 }]}
                >
        ...
        {this.state.popUpUpload ? (
          <View style={styles.uploadImageType}>
            <View style={styles.uploadAction}>
              <View style={styles.actionAlert}>
                <View style={[styles.eachActionSec, { position: "relative" }]}>
                  <View
                    style={[styles.topHeaderBar, styles.actionUploadTopHeader]}
                  >
                    <Text
                      style={{
                        fontWeight: "bold",
                ...
                <TouchableOpacity
                  ...
                  onPress={() => this.uploadImageActionType("galleryAction")}
                >
              ...
              <View style={styles.topHeaderBar}>
                ...
                <View style={[styles.topHeaderBar, styles.rightTopbarHeader]}>
                  ...
                  <TouchableWithoutFeedback onPress={() => this.goToProfile()}>
                    <Image
                      style={[styles.profileHeroImg, styles.topHeaderAvatar]}
                      source={{
                        uri: `${serverUrl}img/author/convert/${this.state.photographerAllData[0].profile_pic}`,
                      }}
                    />
                      ...
                      <View style={styles.bannerProfile}>
                        <View style={styles.profileHero}>
                          <Image
                            ...
                            source={{
                              uri: `${serverUrl}img/author/convert/${item.profile_pic}`,
                            }}
                          />
                        </View>
                    ...
                    return (
                      ...
                      >
                        <Image
                          ...
                          source={{
                            uri: `http://192.168.0.116/jsonClasses/img/userGallary/${item.image_name}`,
                          }}
                        />
                      </TouchableOpacity>
                    );
