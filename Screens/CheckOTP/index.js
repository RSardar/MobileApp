...
export default class CheckOTP extends React.Component {
  ...
  sendRecendCode = () => {
    ...
    var url = `https://2factor.in/API/V1/${api}/SMS/${7076098530}/${otp}`;
    return fetch(url)
  ...
  render() {
    ...
    return (
      <View>
        ...
        <Text style={styles.recendNumber}>+91 {7076098530}</Text>
        ...
        <View>
          ...
          {this.state.recendShow ? (
            <ButtonTouchable
              text={"recend code"}
              customDesign={[styles.customBtn, styles.recendBtn]}
              customBtnDesign={[styles.customBtnText, styles.recendBtnText]}
            />
          ) : null}
        </View>
        ...
        <ButtonTouchable
          ...
          customBtnDesign={[styles.customBtnText]}
